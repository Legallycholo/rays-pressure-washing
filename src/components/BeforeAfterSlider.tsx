  ...
  return (
    <figure className={cn("group relative overflow-hidden rounded-card bg-ink-100", ratios[ratio], className)}>
      ...
      <div
        ...
        style={{ left: `${pos}%` }}
      >
        <span className="absolute top-1/2 left-1/2 grid h-11 w-11 -translate-x-1/2 -translate-y-1/2 place-items-center rounded-full bg-mint-400 text-ink-950 shadow-lift">
      ...
      <span className="pointer-events-none absolute right-3 top-3 z-10 rounded-pill bg-mint-400 px-2.5 py-1 text-[0.7rem] font-bold uppercase tracking-widest text-ink-950">
        After
      </span>
