  ...
  return (
    <Section tone="light" size="flush" className="border-y border-ink-100" innerClassName="py-5">
      <div className="flex flex-wrap items-center justify-center gap-3 gap-y-2 md:justify-between">
        ...
        {/* Anything without art keeps the original text treatment. Filtering on
            `withArt` rather than swapping wholesale means a half-supplied set
            of badges still renders a complete row. */}
        {items
